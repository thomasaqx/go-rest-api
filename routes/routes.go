...
import (
	...
	"github.com/thomasaqx/go-rest-api/middleware"
)

func HandleRequest() {	
	r := mux.NewRouter()                                                                   		//criando uma nova rota com mux //definindo o middleware para definir o Content-Type como application/json
	r.Use(middleware.ContentTypeMiddleware)                                                		//usando o middleware na rota
